...
(function () {
    ...
    window.addEventListener('audioConsoleWakeSound', (e) => {
        ...
        playWakeSound();
        window.dispatchEvent(new CustomEvent('akari:user-input', { detail: { source: 'audioConsole-wakesound' } }));
    });
    window.addEventListener('audioConsoleSpeechStart', () => {
        setVisualState('listening');
        window.dispatchEvent(new CustomEvent('akari:user-input', { detail: { source: 'audioConsole-speechstart' } }));
    });
    ...
    window.addEventListener('audioConsoleResult', (e) => {
        ...
        window.dispatchEvent(new CustomEvent('akari:user-input', { detail: { source: 'audioConsole-result', value: e.detail && e.detail.text } }));
    });
