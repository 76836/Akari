...
function initWakeAudio() {
    ...
    function initAudioConsole() {
        ...
        script.type = 'module';
        script.textContent = `
            import { AkarinetVoice } from 'https://76836.github.io/AkariNet-AudioConsole/audioConsole-4.0.0.js';
            const config = {
    ...
    openWakeWord: {
        keywordURL: 'https://76836.github.io/Akari/engine/models/v2_hey_A_kar_e.onnx'
    },
    ...
    window.addEventListener('audioConsoleReady', () => {
        app.notify('AkariNet', 'Audio Console (adapter 4f) has started successfully!', {
