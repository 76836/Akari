...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>IBM Granite 1b on Wllama (v2.1)</h1>
            <div class="status">
  ...
  async function buildContext(messages) {
    ...
    const checkCachedModel = async () => {
        try {
            ...
            const response = await cache.match('granite-3.0-1b-a400m-instruct-Q4_K_M.gguf');
            return !!response;
        } catch (error) {
    ...
    const initWllama = async () => {
        ...
        try {
            ...
            await wllama.loadModelFromHF(
                'bartowski/granite-3.0-1b-a400m-instruct-Q4_K_M.gguf',
